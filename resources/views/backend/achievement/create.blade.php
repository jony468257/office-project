                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" id="contests_bn"
                                       class="border border-gray-200 text-gray-900 text-sm rounded focus:ring-violet-100 focus:border-violet-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100/60 dark:text-zinc-100"
                                       name="contests_bn"
                                       placeholder="কন্টেস্ট"
                                       value="{{ old('contests_bn') }}"
                                       required>
                                @error('contests_bn')
                                <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            ...
                            <!-- Description (Bangla) -->
                            <div>
                                <label for="description_bn" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-50">Description (Bangla)<span class="text-red-500 text-lg leading-none"> *</span></label>
                                <textarea id="description_bn"
                                          class="border border-gray-200 text-gray-900 text-sm rounded focus:ring-violet-100 focus:border-violet-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100/60 dark:text-zinc-100"
                                          name="description_bn"
                                          placeholder="ডেসক্রিপশন"
                                          required>{{ old('description_bn') }}</textarea>
                            ...
                            <!-- Row Status -->
                            <div>
                                <label for="row_status" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-50">Status<span class="text-red-500 text-lg leading-none"> *</span></label>
