        ...
        <div class="col-span-12 xl:col-span-6">
            <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                <div class="card-body pb-0">
                    <h6 class="mb-1 text-15 text-gray-700 dark:text-gray-100">{{ __('messages.edit') }} {{ __('messages.news_events') }}</h6>
                ...
                <div class="card-body">
                    <form action="{{ route('areas.update', $data->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                @if ($data->image)
                                    <div class="mt-2">
                                        <img src="{{ asset($data->image) }}" alt="Current Image" class="h-20">
                                    </div>
                                @endif
                            </div>

                            <div>
                                <label for="row_status" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-50">Status</label>
