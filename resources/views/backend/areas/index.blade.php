...
@section('title','Area of Activity')
...
@section('content')
    ...
    <div class="grid grid-cols-1 mb-5">
        <div class="flex items-center justify-between">
            <h4 class="mb-sm-0 text-lg font-semibold grow text-gray-800 dark:text-gray-100">{{ __('messages.news_events') }}</h4>
                ...
                <ol class="inline-flex items-center space-x-1 ltr:md:space-x-3 rtl:md:space-x-0">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#" class="ltr:ml-1 rtl:mr-1 text-sm font-medium text-gray-500 hover:text-gray-900 ltr:md:ml-2 rtl:md:mr-2 dark:text-gray-100 dark:hover:text-white">{{ __('messages.news_events') }}</a>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <div class="col-span-12">
            <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                <div class="card-body pb-0">
                    <h6 class="mb-1 text-15 text-gray-700 dark:text-gray-100">{{ __('messages.news_events') }} {{ __('messages.list') }}</h6>
...
{{--                                    @if ($data->type === 0)--}}
{{--                                        <span class="badge font-medium bg-violet-50 text-violet-500 text-xl px-1.5 py-[1.5px] rounded dark:bg-violet-500/20">News</span>--}}
{{--                                    @else--}}
{{--                                        <span class="badge font-medium bg-green-50 text-green-500 text-xl px-1.5 py-[1.5px] rounded dark:bg-green-500/20">Event</span>--}}
{{--                                    @endif--}}
{{--                                </td>--}}
