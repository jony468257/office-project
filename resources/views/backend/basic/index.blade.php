        ...
        <div class="col-span-12">
            <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                <div class="card-body pb-0">
                    <h6 class="mb-1 text-2xl text-gray-700 dark:text-gray-100">{{ __('messages.basic_information') }} {{ __('messages.list') }}</h6>
                ...
                <div class="card-body relative overflow-x-auto">
                    <table id="datatable" class="table w-full pt-4 text-gray-700 dark:text-zinc-100">
                        ...
                        <tr>
                            ...
                            <th class="p-4 pr-8 border border-y-2 border-gray-50 dark:border-zinc-600 border-l-0">Description (Bangla)</th>
                            ...
                            <th class="p-4 pr-8 border border-y-2 border-gray-50 dark:border-zinc-600 border-l-0">Favicon</th>
...
{{--                            <th class="p-4 pr-8 border rtl:border-l border-y-2 border-gray-50 dark:border-zinc-600 border-l-0">Image</th>--}}
                            <th class="p-4 pr-8 border rtl:border-l border-y-2 border-gray-50 dark:border-zinc-600 border-l-0">Copyrights</th>
                        ...
                        <tr>
                            ...
                            <td class="p-4 pr-8 border border-t-0 border-l-0 border-gray-50 dark:border-zinc-600">
                                <img class="inline-block h-14 w-20 rounded ring-2 ring-white dark:ring-zinc-500" src="{{ asset('storage/').'/'. $data->favicon }}"  alt="{{ $data->favicon }}"/>
                            </td>
                            <td class="p-4 pr-8 border border-t-0 border-l-0 border-gray-50 dark:border-zinc-600">
                                <img class="inline-block h-14 w-20 rounded ring-2 ring-white dark:ring-zinc-500" src="{{ asset('storage/').'/'. $data->logo }}"  alt="{{ $data->logo }}"/>
                            </td>
                            <td class="p-4 pr-8 border rtl:border-l border-t-0 border-l-0 border-gray-50 dark:border-zinc-600">{{ $data->copyrights }}</td>
                            <td class="border rtl:border-l border-t-0 border-l-0 border-gray-50 dark:border-zinc-600">
                                    <div class="gap-1 text-center flex justify-center">
                                         <button type="button" class="btn text-white bg-yellow-500 border-yellow-500 hover:bg-yellow-600 hover:border-yellow-600 focus:bg-yellow-600 focus:border-yellow-600 focus:ring focus:ring-yellow-500/30 active:bg-yellow-600 active:border-yellow-600" title="{{ __('messages.edit') }}" onclick="window.location.href='{{ route('basic-information.edit', $data->id) }}'"><i class="bx bx-pencil text-16 align-middle "></i></button>
                                        <div>
                                            <form action="{{ route('basic-information.destroy', $data->id) }}" method="POST" onsubmit="return confirmDeletion()">
                                                @csrf
                                                @method('DELETE')
