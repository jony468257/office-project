        ...
        <div class="col-span-12 xl:col-span-6">
            <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                <div class="card-body pb-0">
                    <h6 class="mb-1 text-2xl text-gray-700 dark:text-gray-100">{{ __('messages.edit') }}{{ __('messages.contacts') }}</h6>
                    ...
                    <form action="{{ route('contact-us.update',$data->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            <div>
                                ...
                                <input type="text" id="name_bn" class=" border border-gray-200 text-gray-900 text-sm rounded focus:ring-violet-100 focus:border-violet-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100/60 dark:text-zinc-100" name="name_bn" value="{{ $data->name_bn }}" required>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="text" id="sub_name_bn" class=" border border-gray-200 text-gray-900 text-sm rounded focus:ring-violet-100 focus:border-violet-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100/60 dark:text-zinc-100" name="sub_name_bn" value="{{ $data->sub_name_bn }}" required>
                            </div>
                            <div>
                                ...
                                <input type="text" id="sub_name_en" class=" border border-gray-200 text-gray-900 text-sm rounded focus:ring-violet-100 focus:border-violet-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100/60 dark:text-zinc-100" name="address" value="{{ $data->address }}">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="number" id="mobile" class=" border border-gray-200 text-gray-900 text-sm rounded focus:ring-violet-100 focus:border-violet-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100/60 dark:text-zinc-100" name="mobile" value="{{ $data->mobile }}">
                            </div>
                            <div class="my-auto">
