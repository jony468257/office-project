        ...
        <div class="col-span-12 xl:col-span-6">
            <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                <div class="card-body pb-0">
                    <h6 class="mb-1 text-15 text-gray-700 dark:text-gray-100">{{ __('messages.edit') }} {{ __('messages.admission_result') }}</h6>
                ...
                <div class="card-body">
                    <form action="{{ route('pricing.update', $data->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            <div>
                                ...
                                <input type="text" id="title_bn" name="title_bn"
                                       ...
                                       placeholder="টাইটেল" required value="{{ old('title_bn', $data->title_bn) }}">
                                @error('title_bn')
                            ...
                            <div>
                                ...
                                <input type="text" id="title_en" name="title_en"
                                       class="border border-gray-200 text-gray-900 text-sm rounded focus:ring-violet-100 focus:border-violet-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100/60 dark:text-zinc-100"
                                       placeholder="Title" value="{{ old('title_en', $data->title_en) }}">
                                @error('title_en')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="sub_title_bn" name="sub_title_bn"
                                       class="border border-gray-200 text-gray-900 text-sm rounded focus:ring-violet-100 focus:border-violet-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100/60 dark:text-zinc-100"
                                       placeholder="সাবটাইটেল" required value="{{ old('sub_title_bn', $data->sub_title_bn) }}">
                                @error('sub_title_bn')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="sub_title_en" name="sub_title_en"
                                       class="border border-gray-200 text-gray-900 text-sm rounded focus:ring-violet-100 focus:border-violet-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100/60 dark:text-zinc-100"
                                       placeholder="Subtitle" value="{{ old('sub_title_en', $data->sub_title_en) }}">
                                @error('sub_title_en')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="price_bn" name="price_bn"
                                       class="border border-gray-200 text-gray-900 text-sm rounded focus:ring-violet-100 focus:border-violet-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100/60 dark:text-zinc-100"
                                       placeholder="মূল্য" required value="{{ old('price_bn', $data->price_bn) }}">
                                @error('price_bn')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" id="price_en" name="price_en"
                                       class="border border-gray-200 text-gray-900 text-sm rounded focus:ring-violet-100 focus:border-violet-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100/60 dark:text-zinc-100"
                                       placeholder="Price" value="{{ old('price_en', $data->price_en) }}">
                                @error('price_en')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="url" id="url" name="url"
                                       class="border border-gray-200 text-gray-900 text-sm rounded focus:ring-violet-100 focus:border-violet-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100/60 dark:text-zinc-100"
                                       placeholder="https://example.com" required value="{{ old('url', $data->url) }}">
                                @error('url')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                @if ($data->attachment)
                                    <p class="text-sm text-gray-600 dark:text-zinc-400 mt-1">
                                        Current Attachment: <a href="{{ asset($data->attachment) }}" target="_blank" class="text-violet-500">View</a>
                                    </p>
                                @endif
                                @error('attachment')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
