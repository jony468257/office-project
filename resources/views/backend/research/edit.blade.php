                ...
                <div class="card-body">
                    <form action="{{ route('research.update',$data->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            ...
                            <div>
                                <label for="works_image" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-50">Working Image<span class="text-red-500 text-lg leading-none"> *</span><span class=" mb-2 text-sm font-medium text-red-500"> [ Size: 1024 x 720 ]</span></label>
                                <input type="file" id="works_image" class=" border border-gray-200 text-gray-900 text-sm rounded focus:ring-violet-100 focus:border-violet-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100/60 dark:text-zinc-100" name="works_image" value="{{ $data->works_image }}">
                            </div>
                            <div class="my-auto">
                                <label for="works_image" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-50">Old Picture</label>
                                <img class="inline-block h-14 w-14 rounded ring-2 ring-white dark:ring-zinc-500" src="{{ asset('storage/').'/'. $data->works_image }}"  alt="{{ $data->works_image }}"/>
                            </div>
