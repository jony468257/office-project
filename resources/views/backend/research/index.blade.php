        ...
        <div class="col-span-12">
            <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                <div class="card-body pb-0">
                    <h6 class="mb-1 text-15 text-gray-700 dark:text-gray-100">{{ __('messages.history') }} {{ __('messages.list') }}</h6>
                ...
                <div class="card-body relative overflow-x-auto">
                    <table id="datatable" class="table w-full pt-4 text-gray-700 dark:text-zinc-100">
                        ...
                        <tr>
                            ...
                            <th class="p-4 pr-8 border border-y-2 border-gray-50 dark:border-zinc-600 border-l-0">Button Name</th>

                            <th class="p-4 pr-8 border border-y-2 border-gray-50 dark:border-zinc-600">Banner Image</th>
                            <th class="p-4 pr-8 border border-y-2 border-gray-50 dark:border-zinc-600">Problem</th>
                            <th class="p-4 pr-8 border border-y-2 border-gray-50 dark:border-zinc-600">Problem Description</th>
                            <th class="p-4 pr-8 border border-y-2 border-gray-50 dark:border-zinc-600">Solution Title</th>
                            <th class="p-4 pr-8 border border-y-2 border-gray-50 dark:border-zinc-600">Solution Image</th>
                            <th class="p-4 pr-8 border border-y-2 border-gray-50 dark:border-zinc-600">Features Title</th>

                            <th class="p-4 pr-8 border border-y-2 border-gray-50 dark:border-zinc-600 border-l-0">Solution Datas</th>
                            <th class="p-4 pr-8 border border-y-2 border-gray-50 dark:border-zinc-600 border-l-0">Feature Datas</th>
                        ...
                        @foreach($datas as $key => $data)
                            <tr>
                                ...
                                <td class="p-4 pr-8 border border-t-0 border-l-0 border-gray-50 dark:border-zinc-600">{{ $data->description_bn }}</td>
                                <td class="p-4 pr-8 border rtl:border-l border-t-0 border-l-0 border-gray-50 dark:border-zinc-600">{{ $data->description_en }}</td>
                                ...
                                <td class="p-4 pr-8 border rtl:border-l border-t-0 border-l-0 border-gray-50 dark:border-zinc-600">{{ $data->button_name }}</td>
                                <td class="p-4 pr-8 border rtl:border-l border-t-0 border-l-0 border-gray-50 dark:border-zinc-600">
                                ...
                                <td class="p-4 pr-8 border rtl:border-l border-t-0 border-l-0 border-gray-50 dark:border-zinc-600">{{ $data->problem }}</td>
                                <td class="p-4 pr-8 border rtl:border-l border-t-0 border-l-0 border-gray-50 dark:border-zinc-600">{{ $data->problem_desc }}</td>
                                <td class="p-4 pr-8 border rtl:border-l border-t-0 border-l-0 border-gray-50 dark:border-zinc-600">{{ $data->solution_title }}</td>
                                <td class="p-4 pr-8 border rtl:border-l border-t-0 border-l-0 border-gray-50 dark:border-zinc-600">{{ $data->features_title }}</td>
                                <td class="p-4 pr-8 border rtl:border-l border-t-0 border-l-0 border-gray-50 dark:border-zinc-600">
                                ...
                                <td class="p-4 pr-8 border rtl:border-l border-t-0 border-l-0 border-gray-50 dark:border-zinc-600">
                                    <ul>
                                        @php
                                            $solutionData = json_decode($data->solution_data, true);
                                        @endphp
                                        @if($solutionData)
                                            @foreach($solutionData as $index => $solution)
                                                <li>
                                                    {{ $solution['key'] }}
                                                    <br>
                                            ...
                                            @endforeach
                                        @else
                                            <li>No solution data available</li>
                                        @endif
                                    </ul>
                                </td>
                                ...
                                <td class="p-4 pr-8 border rtl:border-l border-t-0 border-l-0 border-gray-50 dark:border-zinc-600">
                                    <ul>
                                        @php
                                            $featuresData = json_decode($data->features_data, true);
                                        @endphp
                                        @if($featuresData)
                                            @foreach($featuresData as $index => $feature)
                                                <li>
                                                    {{ $feature['key'] }}
                                                    <br>
                                                    <img src="{{ asset($feature['image']) }}" alt="Feature Image" style="width: 100px; height: auto;">,
                                                </li>
                                            @endforeach
                                        @else
                                            <li>No features data available</li>
                                        @endif
                                    </ul>
                                </td>
