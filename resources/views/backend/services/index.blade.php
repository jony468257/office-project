        ...
        <div class="col-span-12">
            <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                <div class="card-body pb-0">
                    <h6 class="mb-1 text-15 text-gray-700 dark:text-gray-100">{{ __('messages.infrastructure') }} {{ __('messages.list') }}</h6>
                ...
                <div class="card-body relative overflow-x-auto">
                    <table id="datatable" class="table w-full pt-4 text-gray-700 dark:text-zinc-100">
                        ...
                        <tr>
                            ...
                            <th class="p-4 pr-8 border border-y-2 border-gray-50 dark:border-zinc-600 border-l-0">Banner Image</th>
                        ...
                        @foreach($datas as $key => $data)
                            <tr>
                                ...
                                <td class="p-4 pr-8 border rtl:border-l border-t-0 border-l-0 border-gray-50 dark:border-zinc-600">
                                    <img class="inline-block h-14 w-30 rounded ring-2 ring-white dark:ring-zinc-500" src="{{ asset('storage/').'/'. $data->banner_image }}"  alt="{{ $data->banner_image }}"/>
                                </td>
