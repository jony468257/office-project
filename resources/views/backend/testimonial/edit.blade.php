        ...
        <div class="col-span-12 xl:col-span-6">
            <div class="card dark:bg-zinc-800 dark:border-zinc-600">
                <div class="card-body pb-0">
                    <h6 class="mb-1 text-15 text-gray-700 dark:text-gray-100">{{ __('messages.edit') }} {{ __('messages.notice') }}</h6>
                ...
                <div class="card-body">
                    <form action="{{ route('testimonial.update', $data->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            <div>
                                <label for="name_bn" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-50">
                                    Name (Bangla)<span class="text-red-500 text-lg leading-none"> *</span>
                                </label>
                                <input type="text" id="name_bn"
                                       ...
                                       name="name_bn"
                                       value="{{ old('name_bn', $data->name_bn) }}"
                                       placeholder="নাম"
                                       required>
                                @error('name_bn')
                            ...
                            <div>
                                <label for="farm_name_bn" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-50">
                                    Farm Name (Bangla)<span class="text-red-500 text-lg leading-none"> *</span>
                                </label>
                                <input type="text" id="farm_name_bn"
                                       class="border border-gray-200 text-gray-900 text-sm rounded focus:ring-violet-100 focus:border-violet-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100/60 dark:text-zinc-100"
                                       name="farm_name_bn"
                                       value="{{ old('farm_name_bn', $data->farm_name_bn) }}"
                                       placeholder="ফার্ম নাম"
                                       required>
                                @error('farm_name_bn')
                                <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                                @enderror
                            ...
                            <div>
                                <label for="farm_name_en" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-50">Farm Name (English)</label>
                                <input type="text" id="farm_name_en"
                                       class="border border-gray-200 text-gray-900 text-sm rounded focus:ring-violet-100 focus:border-violet-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100/60 dark:text-zinc-100"
                                       name="farm_name_en"
                                       value="{{ old('farm_name_en', $data->farm_name_en) }}"
                            ...
                            <div>
                                <label for="address_bn" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-50">
                                    Address (Bangla)<span class="text-red-500 text-lg leading-none"> *</span>
                                </label>
                                <input type="text" id="address_bn"
                                       class="border border-gray-200 text-gray-900 text-sm rounded focus:ring-violet-100 focus:border-violet-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100/60 dark:text-zinc-100"
                                       name="address_bn"
                            ...
                            <div>
                                <label for="address_en" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-50">Address (English)</label>
                            ...
                            <div>
                                ...
                                <textarea id="description_bn"
                                          class="border border-gray-200 text-gray-900 text-sm rounded focus:ring-violet-100 focus:border-violet-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100/60 dark:text-zinc-100"
                                          name="description_bn"
                                          placeholder="বর্ণনা">{{ old('description_bn', $data->description_bn) }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea id="description_en"
                                          class="border border-gray-200 text-gray-900 text-sm rounded focus:ring-violet-100 focus:border-violet-500 block w-full p-2.5 dark:bg-zinc-700/50 dark:border-zinc-600 dark:placeholder:text-zinc-100/60 dark:text-zinc-100"
                                          name="description_en"
                                          placeholder="Description">{{ old('description_en', $data->description_en) }}</textarea>
                            ...
                            <div>
                                ...
                                <input type="file" id="image"
                                       ...
                                       name="image">
                                @if ($data->image)
                                    <img src="{{ asset('storage/' . $data->image) }}" alt="{{ $data->name_en }}" class="h-16 w-16 object-cover rounded mt-2">
                                @else
                                    No current image
                                @endif
                                @error('image')
